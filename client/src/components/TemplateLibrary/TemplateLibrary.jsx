        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          <div className="mb-6">
            ...
            <div className="bg-white border rounded-xl p-4 overflow-x-auto">
              <div style={{minWidth:Math.max((maxRel+1)*32+320,680)}}>
